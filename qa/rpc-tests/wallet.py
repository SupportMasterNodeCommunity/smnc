...
#   c) node1 mines 32 blocks, so now node 0 has 60001SMNC, node 1 has 4250SMNC, node2 has none.
#   d) node0 sends 601 SMNC to node2, in two transactions (301 SMNC, then 300 SMNC).
