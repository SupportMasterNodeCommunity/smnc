...
#ifndef SupportMasterNodeCommunity_ACCUMULATORCHECKPOINTS_JSON_H
#define SupportMasterNodeCommunity_ACCUMULATORCHECKPOINTS_JSON_H
...
#endif //SupportMasterNodeCommunity_ACCUMULATORCHECKPOINTS_JSON_H
