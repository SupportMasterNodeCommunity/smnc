Contributing to SupportMasterNodeCommunity
============================

The SupportMasterNodeCommunity project operates an open contributor model where anyone is
...
The following applies to code changes to the SupportMasterNodeCommunity project, and is not to be
confused with overall SupportMasterNodeCommunity Network Protocol consensus changes.

Whether a pull request is merged into SupportMasterNodeCommunity rests with the project merge
...
Patches that change SupportMasterNodeCommunity consensus rules are considerably more involved than
...
Where a patch set proposes to change the SupportMasterNodeCommunity consensus, it must have been
...
The project leader is the release manager for each SupportMasterNodeCommunity release.
