...
#ifndef SupportMasterNodeCommunity_HASH_H
#define SupportMasterNodeCommunity_HASH_H
...
#define ZBSMNC (memcpy(&ctx_bmw, &z_bmw, sizeof(z_bmw)))
...
#endif // SupportMasterNodeCommunity_HASH_H
