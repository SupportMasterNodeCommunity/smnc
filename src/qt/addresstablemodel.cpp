...
void AddressTableModel::updateEntry(const QString& address,
    ...
    int status)
{
    // Update address book model from SupportMasterNodeCommunity
...
{
    emit dataChanged(index(idx, 0, QModelIndex()), index(idx, colusmnc.length() - 1, QModelIndex()));
}
