...
public:
    ...
    void setZSMNCControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzsmnc_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzsmnc_clicked();
    void on_pushButtonZSMNCControl_clicked();
