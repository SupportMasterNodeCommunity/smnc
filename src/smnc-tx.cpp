...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SupportMasterNodeCommunity smnc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  smnc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smnc transaction") + "\n" +
                               "  smnc-tx [options] -create [commands]   " + _("Create hex-encoded smnc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded smnc transaction
