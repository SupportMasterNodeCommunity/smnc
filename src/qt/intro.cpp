...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SupportMasterNodeCommunity"),
     ...
     * override -datadir in the smnc.conf file in the default data directory
     * (to be consistent with smncd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
