...
#ifndef SupportMasterNodeCommunity_ZSMNCTRACKER_H
#define SupportMasterNodeCommunity_ZSMNCTRACKER_H
...
public:
    CzsmncTracker(std::string strWalletFile);
    ~CzsmncTracker();
...
#endif //SupportMasterNodeCommunity_ZSMNCTRACKER_H
