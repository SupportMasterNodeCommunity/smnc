...
In order to support loading of multiple wallets in smnc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smnc.cpp.
...
Changes to smnc.cpp
----------------------
smnc.cpp is the entry point into smnc-qt, and as such, will require some minor modifications to provide hooks for
