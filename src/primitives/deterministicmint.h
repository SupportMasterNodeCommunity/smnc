...
#ifndef SupportMasterNodeCommunity_DETERMINISTICMINT_H
#define SupportMasterNodeCommunity_DETERMINISTICMINT_H
...
#endif //SupportMasterNodeCommunity_DETERMINISTICMINT_H
